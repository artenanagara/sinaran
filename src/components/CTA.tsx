...
export default function CTA() {
  ...
  useGSAP(
    () => {
      ...
      gsap.set('.cta-inner', { opacity: 0, y: 36 })
  ...
  return (
    <section ref={ref} className="py-24 px-6 bg-white">
      <div className="max-w-5xl mx-auto">
        ...
        <div className="cta-inner rounded-3xl bg-[#0F1117] px-10 py-16 md:px-16 md:py-20 relative overflow-hidden">
          {/* Glow accents */}
          <div
          ...
          <div className="relative text-center max-w-xl mx-auto">
            ...
            <h2 className="text-[36px] md:text-[44px] font-bold tracking-tight text-white leading-[1.1] mb-5">
              Siap wujudkan{' '}
              <span className="text-[#1A6BFF]">proyek digital</span> Anda?
            </h2>
            <p className="text-[15px] text-white/50 mb-10 leading-relaxed">
              Konsultasi gratis, tanpa komitmen. Kami bantu dari nol sampai live.
            </p>
            <div className="flex gap-3 justify-center flex-wrap">
              ...
              <button className="inline-flex items-center gap-2 text-[14px] font-medium text-white/70 px-6 py-3.5 rounded-xl border border-white/10 hover:border-white/20 hover:bg-white/5 transition-all">
                Kirim Brief Proyek
