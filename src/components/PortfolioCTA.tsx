...
export default function PortfolioCTA() {
  ...
  useGSAP(
    () => {
      ...
      gsap.set('.pfcta-inner', { opacity: 0, y: 36 })

      ScrollTrigger.create({
        trigger: ref.current, start: 'top 82%', once: true,
        onEnter: () => {
          gsap.to('.pfcta-inner', { opacity: 1, y: 0, duration: 0.9, ease: 'power3.out' })
        },
      })
    },
    { scope: ref },
  ...
  return (
    <section ref={ref} className="py-24 px-6 bg-white">
      <div className="max-w-5xl mx-auto">
        ...
        <div className="pfcta-inner rounded-3xl bg-[#0F1117] px-10 py-16 md:px-16 md:py-20 relative overflow-hidden">
          {/* Glow accents */}
          <div
          ...
          <div className="relative text-center max-w-xl mx-auto">
            <p className="text-[11px] font-semibold uppercase tracking-[2px] text-[#1A6BFF] mb-5">
              Selanjutnya
            </p>
            <h2 className="text-[36px] md:text-[44px] font-bold tracking-tight text-white leading-[1.1] mb-5">
              Proyek Anda bisa jadi{' '}
              <span className="text-[#1A6BFF]">yang berikutnya</span>
            </h2>
            <p className="text-[15px] text-white/50 mb-10 leading-relaxed">
              Konsultasi gratis, tanpa komitmen. Ceritakan kebutuhan Anda dan kami bantu wujudkan.
            </p>
